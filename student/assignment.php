 ...
 <div class="container">
     ...
     <table class="menu-container" border="0">
        ...
        <?php
                ...
                $sqlmain= "select * from assignment where student_id=$userid order by assignment_startdate asc";
                $sqlpt1="";
                $insertkey="";
                $q='';
                        ...
                        if(!empty($_POST["search"])){
                            ...
                            $sqlmain= "select * from assignment where student_id=$userid and (assignment_title='$keyword' or assignment_title like '$keyword%' or assignment_title like '%$keyword' or assignment_title like '%$keyword%' or 
                            assignment_startdate like '$keyword%' or assignment_startdate like '%$keyword' or assignment_startdate like '%$keyword%' or assignment_startdate='$keyword' or 
                            // assignment_enddate like '$keyword%' or assignment_enddate like '%$keyword' or assignment_enddate like '%$keyword%' or assignment_enddate='$keyword' )  order by assignment.assignment_startdate asc";
                            $insertkey=$keyword;
                                                ...
                                                <div  class="dashboard-items search-items"  >
                                                    ...
                                                    <div style="width:100%">
                                                        ...
                                                        '.substr($endaya,0,21).'
                                                            ...
                                                            <br>
                                                            <a href="done-assignment.php?id='.$assignment_id.'" ><button  class="login-btn btn-primary-soft btn "  style="padding-top:11px;padding-bottom:11px;width:100%"><font class="tn-in-text">تم الواجب المنزلي</font></button></a>
                                                    </div>
