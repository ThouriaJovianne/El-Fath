            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <tr >
                            ...
                            <td width="15%">
                                ...
                                $schedulerow = $database->query("select  * from  assignment where assignment_startdate='$today';");
                                ...
                                <td width="50%">
                                    <center>
                                        ...
                                        <tbody>
                                            ...
                                            $sqlmain= "select appointment.appoid,assignment.assignment_id,assignment.assignment_title,teacher.teacher_name,student.student_name,assignment.assignment_startdate,assignment.assignment_enddate,appointment.apponum,appointment.appodate from assignment inner join appointment on assignment.assignment_id=appointment.scheduleid inner join student on student.student_id=assignment.student_id inner join teacher on assignment.student_id=student.student_id  where assignment.assignment_enddate>='$today'  and assignment.assignment_enddate<='$nextweek' order by assignment.assignment_startdate desc";
                                ...
                                <td width="50%" style="padding: 0;">
                                    <center>
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $nextweek=date("Y-m-d",strtotime("+1 week"));
                                            $sqlmain= "select * from student order by student_id asc"; 
                                                $result= $database->query($sqlmain);
                                                ...
                                                for ( $x=0; $x<$result->num_rows;$x++){
                                                    $row=$result->fetch_assoc();
                                                    $scheduleid=$row["student_name"];
                                                    $title=$row["student_email"];
                                                    $docname=$row["student_name"];
                                                    $scheduledate=$row["student_phone"];
                                                    $scheduletime=$row["student_birthdate"];
