    ...
    <div class="container">
            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor menu-active menu-icon-doctor-active">
                        <a href="teachers.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">الأساتذة</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-appoinment">
                        <a href="appointment.php" class="non-style-link-menu"><div><p class="menu-text">الإعدادت</p></a></div>
                    </td>
                </tr>
            </table>
        </div>
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    <td width="13%">
                        <a href="teachers.php" ><button  class="login-btn btn-primary-soft btn btn-icon-back"  style="padding-top:11px;padding-bottom:11px;margin-left:20px;width:125px"><font class="tn-in-text">الرجوع</font></button></a>
                    </td>
                    <td>
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <a class="non-style-link" href="teachers.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; أظهر جميع الأساتذة &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    // $job_result= $database->query("select job_name from jobs where id='$teacher_job'");
                                    ...
                                    echo '<tr>
                                        <td> &nbsp;'.
                                        substr($teacher_name,0,30)
                                        .'</td>
                                        <td>
                                        '.substr($teacher_email,0,20).'
                                        </td>
                                        <td>
                                            '.substr($teacher_phone,0,20).'
                                        </td>
                                        <td>
                                        '.substr($teacher_homeaddress,0,20).'
                                        </td>


                                        <td>
                                        <div style="display:flex;justify-content: center;">
                                        <a href="?action=edit&id='.$teacher_id.'&error=0" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-edit" style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">تعديل</font></button></a>
                                        &nbsp;&nbsp;&nbsp;
                                        <a href="?action=view&id='.$teacher_id.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-view" style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">رؤية</font></button></a>
                                       &nbsp;&nbsp;&nbsp;
                                       <a href="?action=drop&id='.$teacher_id.'&name='.$teacher_name.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-delete" style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">حذف</font></button></a>
                                        </div>
                                        </td>
                                    </tr>';
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <form action="add-teacher.php" method="POST" class="add-new-form">
                                <td class="label-td" colspan="2">
                                    <label for="teacher_name" class="form-label">الاسم: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="teacher_name" class="input-text" placeholder="اسم الأستاذ" required><br>
                                </td>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="email" name="teacher_email" class="input-text" placeholder="البريد الالكتروني" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="teacher_homeaddress" class="input-text" placeholder="عنوان المنزل" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="tel" name="teacher_phone" class="input-text" placeholder="رقم الهاتف" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                    ...
                    echo     '       </select><br><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <select name="teacher_educationallevel" id="" class="box" >';
                        ...
                        <tr>
                            <td class="label-td" colspan="2">
                                <select name="teacher_scholaryear" id="" class="box" >';
                    ...
                    <tr>
                        <td class="label-td" colspan="2">
                            <select name="teacher_class" id="" class="box" >';
